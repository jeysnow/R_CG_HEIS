Normalize_Names_HEI <- function(NAMES_VECTOR,NAMES_NORMAL) {
  print("Normalize_Names_HEI is not yet implemented")
  stop()
  
  if (!is.vector(NAMES_VECTOR)) {
    print("Normalize_Names_HEI received names that are not a vector")
    stop()
  }
